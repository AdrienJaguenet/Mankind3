				  ...
				  bool enabled_faces[6])
{
	...
	vec3_t real_start = vec3(aabb->pos.x / BLOCK_SIZE, aabb->pos.y / BLOCK_SIZE, aabb->pos.z / BLOCK_SIZE);
	vec3_t real_dim = vec3(aabb->dim.x / BLOCK_SIZE, aabb->dim.y / BLOCK_SIZE, aabb->dim.z / BLOCK_SIZE);
